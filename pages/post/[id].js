...
const ipfsURI = 'https://yuanpass.infura-ipfs.io/ipfs'
          ...
          <div className={container}>
            {
              ...
              ownerAddress === account && (
                <div className={editPost}>
                  <Link legacyBehavior href={`/edit-post/${id}`}>
                    <a>
                      Edit post
                    </a>
                  </Link>
...
export async function getStaticPaths() {
  ...
  if (process.env.ENVIRONMENT === 'local') {
    ...
    provider = new ethers.providers.JsonRpcProvider('https://polygon-mumbai.blockpi.network/v1/rpc/public')
  } else {
...
export async function getStaticProps({ params }) {
  ...
  console.log('fectch url =', ipfsUrl)
